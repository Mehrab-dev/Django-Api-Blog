...
urlpatterns = [
    ...
    path("posts/<int:pk>/",views.PostModelViewSets.as_view({"get":"retrieve","put":"update","delete":"destroy"}),name="post_detail_modelviewsets"),

    path("categories/",views.CategoryModelViewSets.as_view({"get":"list","post":"create"}),name="category_modelviewsets"),
    path("categories/<int:pk>/",views.CategoryModelViewSets.as_view({"get":"retrieve","put":"update","delete":"destroy"}),name="categories_detail_modelviewsets"),
]